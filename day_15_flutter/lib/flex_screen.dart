...
class FlexScreen extends StatelessWidget {
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          ...
          Expanded(
              child:
                  LabeledContainer(color: Colors.purple, text: 'The Remainder', textColor: Colors.white,),),
  ...
  Widget _buildFlexible(BuildContext context) {
    return SizedBox(
      height: 100,
      child: Row(
        children: [Flexible(flex: 1, child: LabeledContainer(color: Colors.orange, text: '25%')),
        Flexible(flex: 1, child: LabeledContainer(color: Colors.deepOrange, text: '25%')),
          Flexible(flex: 2, child: LabeledContainer(color: Colors.blue, text: '50%'))
        ],
